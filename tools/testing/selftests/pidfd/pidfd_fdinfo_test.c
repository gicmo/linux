...
static int compare_fdinfo_nspid(int pidfd, char *expect, struct error *err)
{
	char path[512];
	FILE *f;
	size_t n = 0;
			       ...
			       const char *expect, ...)
{
	...
	return compare_fdinfo_nspid(pidfd, buffer, err);
}
