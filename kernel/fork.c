 ...
 * pid namespace of the opener's procfs instance. The difference becomes
 * obvious when sending around a pidfd between pid namespaces from a
 * different branch of the tree, i.e. where no ancestoral relation is present
 * between the pid namespaces:
 ...
 * - read /proc/self/fdinfo/<pidfd> and observe that Pid and NSpid entries
 *   are 0
